/*---
name: leftPage
summary: Draw text or an image on the left half of the page.
params:
  - name: material
...
returns: void
example: |
  cover.leftPage("left text", 10, 20);
---*/

export const name = "leftPage";
...
export const meta = {
  ...
  returns: "void",
  example: "cover.leftPage(\"left text\", 10, 20);",
};
